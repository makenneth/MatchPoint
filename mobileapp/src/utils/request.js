...
// sign up or log in will call a different api than web
// then it will use that cookie - which is deemed permissible to access api without CSRF token
// or create a new endpoint. But either way, I will need to distinguish cookies to secure endpoint
// maybe an extra database that stores the info.. or a NoSQL database
// token - device
